...
let avatarSpeedA = 3.5; //at which to add to speed every frame of keyDown (acceleration)
...
let enemySpeed = 1;
let enemySpeedInc = 64; //affects the rate at which to increase enemySpeed per dodge(), higher value is LESS increment
...
//in lost state canvas interpolates back to canvasHeightInitial
  ...
  createCanvas(displayWidth/7,canvasHeight);
